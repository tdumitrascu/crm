package com.tdumitrascu.crm.controllers;
...
import com.tdumitrascu.crm.services.CustomerService;
...
public class CustomerWebController {
    ...
    @PostMapping("/update")
    public String update(@Validated @ModelAttribute("customerInstance") Customer customerInstance,
    ...
    @PostMapping("/save")
    public String save(@Validated @ModelAttribute("customerInstance") Customer customerInstance,
                       BindingResult bindingResult,
                       Model model,
                       RedirectAttributes atts) {
        if (bindingResult.hasErrors()) {
            ...
            customerRepository.save(customerInstance); // Save the entity
